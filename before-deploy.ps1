...
if (Enter-OncePerDeployment "install_docker_image")
{
	...
	docker run -d -e "tokens=$env:TOKENS" -e "APPINSIGHTS_INSTRUMENTATIONKEY=e210bb4c-ee0f-4d1f-a892-9b9728fec526" -p 80:80/tcp --name CSDiscord --hostname CSDiscord "cisien/csdiscord:$tag"
}